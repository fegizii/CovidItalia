...
public class MainActivity extends AppCompatActivity {
    ...
    private static String JSON_REGIONI_RESPONSE = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String dataSourceRegioni = "https://raw.githubusercontent.com/pcm-dpc/COVID-19/master/dati-json/dpc-covid19-ita-regioni-latest.json";
        ...
        class JsonLoader extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... strings) {
                ...
                String s = jsonReader.readFromURL(strings[0]);

                return s;
            }

            @Override
            protected void onPostExecute(String s) {        //TODO Too much happening in this method?

                //Create teh JSON Array from the string
                JSONArray jsonArrayRegioni = null;
                try {
                    jsonArrayRegioni = new JSONArray(s);
                ...
                final RegioneAdapter regioneAdapter = new RegioneAdapter(MainActivity.this, regioni);
        ...
        new JsonLoader().execute(dataSourceRegioni);
